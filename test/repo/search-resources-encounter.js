...
tap.test(
  ...
  common.testWithRepo(async (t, repo) => {
    await repo._db
      ...
      .deleteMany({resourceType: 'Encounter'})
    ...
    t.test(
      'should return all encounters when no query parameters are specified',
      async t => {
    ...
    t.test(
      'should return the correct encounters when searching by subject absolute reference',
      async t => {
        const expectedResources = existingResources.filter(resource => {
          return (
    ...
    t.test(
      'should return the correct encounters when searching by subject id reference',
      async t => {
        const expectedResources = existingResources.filter(resource => {
          return (
            resource.resourceType === 'Encounter' &&
    ...
    t.test(
      'should return the correct encounters when searching by class',
      async t => {
        const expectedResources = existingResources.filter(resource => {
          return (
            resource.resourceType === 'Encounter' &&
    ...
    t.test(
      'should return the correct encounters when searching by two classes',
      async t => {
        const expectedResources = existingResources.filter(resource => {
          return (
            resource.resourceType === 'Encounter' &&
    ...
    t.test(
      'should return the correct encounters when searching by subject id reference and class',
      async t => {
        const expectedResources = existingResources.filter(resource => {
          return (
            resource.resourceType === 'Encounter' &&
        ...
        const {resources: returnedResources} = await repo.searchResources(
          'Encounter',
          {'subject:Patient': patientId, class: outpatient}
        )
        t.deepEqual(returnedResources, expectedResources)
      }
    )
