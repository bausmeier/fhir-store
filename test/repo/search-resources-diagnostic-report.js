...
tap.test('searchResources - DiagnosticReport', common.testWithRepo(async (t, repo) => {
  await repo._db.collection('resources').deleteMany({resourceType: 'DiagnosticReport'})
