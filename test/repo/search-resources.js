...
tap.test('searchResources', common.testWithRepo(async (t, repo) => {
...
tap.test('searchResources - sort', common.testWithRepo(async (t, repo) => {
  await repo._db.collection('resources').deleteMany({})
...
tap.test('searchResources by id', common.testWithRepo(async (t, repo) => {
  t.beforeEach(async () => {
    await repo._db.collection('resources').deleteMany({})
  })
