...
tap.test(
  ...
  common.testWithRepo(async (t, repo) => {
    t.test(
      "should insert the resource into the 'resources' collection",
      async t => {
        ...
        const createdResource = await repo._db
    ...
    t.test(
      "should insert the resource into the 'versions' collection",
      async t => {
        const resource = common.generatePatient()
    ...
    t.test(
      'should return a conflict error when the resource is a duplicate',
      async t => {
        const resource = common.generatePatient()
